                ...
                <div class="filter-dropdown" id="filter-dropdown">
                    <div class="filter-section">
                        ...
                        <div class="filter-options">
                            <label class="filter-option"><input type="checkbox" name="role" value="PA"> Donor</label>
                            <label class="filter-option"><input type="checkbox" name="role" value="FA"> Food Bank Account</label>
                            <label class="filter-option"><input type="checkbox" name="role" value="AA"> Admin</label>
                        </div>
                    </div>
