...
try {
    ...
    $stmt = $pdo->prepare("
        SELECT
            ...
            -- Food bank manager
            mu.First_Name AS Manager_First,
            mu.Last_Name  AS Manager_Last,
            mfa.Phone_Number AS Manager_Phone,
        ...
        JOIN ACCOUNTS mfa ON fb.Account_ID = mfa.Account_ID
        JOIN USERS mu     ON mfa.User_ID = mu.User_ID
...
<!-- Modal Scripts -->
<script src="/foodbank/frontend/assets/js/modals/donation_modals.js"></script>
