...
ADD COLUMN Manager_Profile_Picture_URL VARCHAR(255) DEFAULT NULL;
...
CREATE TABLE MESSAGES (
    ...
    FOREIGN KEY (Sender_Account_ID) REFERENCES ACCOUNTS(Account_ID) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY (Receiver_Account_ID) REFERENCES ACCOUNTS(Account_ID) ON DELETE CASCADE ON UPDATE CASCADE
);
